...
// ─── VoIP call ────────────────────────────────────────────────────────────
//
// Runs in a dedicated child process (lib/voip/worker.js), not in-process.
...
const VOIP_WORKER_PATH = path.join(__dirname, 'voip', 'modules', 'worker.js')
...
// One-time voip device pairing — see lib/voip/worker.js `runPairOnly`.
