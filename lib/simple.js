...
/** v4+ awesome-phonenumber API: PhoneNumber(...).getNumber('international') no longer exists.
 *  This helper mimics the old behavior, falling back to the raw '+number' if parsing fails. */
