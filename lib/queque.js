        ...
        return new Promise((resolve, reject) => {
            ...
            if (this.has(item)) {
                ...
                const cleanup = () => {
                    ...
                    this.off(item, solve) // pastikan listener kehapus di semua jalur keluar
                }
                ...
                if (this.isFirst(item)) {
                    ...
                    // Safety net: kalau item ini nggak pernah di-unqueue (item hilang
                    // dari antrian karena error/edge-case lain tanpa emit event),
                    // jangan biarkan listener & promise nyangkut selamanya.
                    timer = setTimeout(() => {
                        cleanup()
                        this.delete(item) // buang juga dari _queque biar nggak numpuk
