...
export class WaCallMediaSession {
    ...
    onRelayVideoData(data) {
        this.videoRelayPacketCount = (this.videoRelayPacketCount ?? 0) + 1;
        ...
        try {
            ...
            if (complete && accessUnit) {
                this.videoAccessUnitCount = (this.videoAccessUnitCount ?? 0) + 1;
        ...
        this.diagnosticTimer = setInterval(() => {
            ...
            this.logger.warn('[VOIP-DIAG]', {
                ...
                video: this.info.mediaType === CallMediaType.Video ? {
                    ...
                    recvPackets: this.videoRelayPacketCount ?? 0,
                    recvAccessUnits: this.videoAccessUnitCount ?? 0
                } : undefined,
                relay: {
