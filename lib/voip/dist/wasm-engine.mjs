...
export class WasmEngine {
    ...
    #applyDefaultAbProps = () => {
        ...
        const intProps = {
            ...
            // Opus bandwidth: trying Superwideband (12 kHz) instead of the
            // original Wideband (8 kHz) for better quality. Fullband (20 kHz)
            // is avoided per the original comment — it needs native audio
            // device hooks not available in this JS-only WASM context.
            opus_max_bandwidth: 1104, // OPUS_BANDWIDTH_SUPERWIDEBAND
        };
        const boolProps = {
