...
// Diturunkan dari 20 (default asli, porting dari browser WhatsApp Web
// dengan banyak core tersedia) ke 6. User sudah menguji PTHREAD_POOL_SIZE=1
// dan call tetap berjalan lancar untuk 1-on-1 call biasa, jadi 20 jauh
// lebih tinggi dari yang dibutuhkan skenario ini — tiap worker thread
// menambah overhead memory (V8 isolate + WASM linear memory view)
// terlepas dari shared memory pool utamanya. 6 dipilih sebagai margin
// aman di atas 1 (bukan langsung sekecil itu) untuk jaga-jaga skenario
// yang belum pernah dites (mis. reconnect, jaringan tidak stabil).
const PTHREAD_POOL_SIZE = 2;
