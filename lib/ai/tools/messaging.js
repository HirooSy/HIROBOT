import { ctx, buildMediaPart, getDangerousDocReason, getUserIdentity, injectRelayContext, readOwnerList } from '../mcp.js';
export default [
{
    name: 'send_message',
