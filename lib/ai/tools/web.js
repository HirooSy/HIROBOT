import { ctx, MODELS, captureWebsiteScreenshot, detectPlatform, fetchWebsiteHtmlFallback, getNextKey, getPersonality, peekAnalyzeWithVision, peekFetchBuffer, peekFetchVideoBuffer, searchWebGrounded } from '../mcp.js';
import fs from 'fs'
