...
file "lib/scraper/test.js" di bawah ini CUMA CONTOH PERAGA FORMAT — di entri sungguhan, ganti
...
export async function downloadTwitterDirect(query) {
    ...
    const { twitter, gifToMp4, isLink } = await import('../scraper/x.js');
